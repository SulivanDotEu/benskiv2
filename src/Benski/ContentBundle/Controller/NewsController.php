...
class NewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BenskiContentBundle:News')->findAll();

        return $this->render('BenskiContentBundle:News:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('BenskiContentBundle:News:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        return $this->render('BenskiContentBundle:News:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BenskiContentBundle:News:edit.html.twig', array(
            'entity'      => $entity,
